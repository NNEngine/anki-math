...
\item What are typical mistakes when applying the Direct Comparison Test?

\item What are typical mistakes when applying the Limit Comparison Test?

\item How can you check your result after applying a comparison test?

\item When comparing $\frac{1}{n^2+1}$ to $\frac{1}{n^2}$, why does the comparison work?

\item What properties of inequalities are essential when using the Direct Comparison Test?
